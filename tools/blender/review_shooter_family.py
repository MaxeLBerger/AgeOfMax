...
def main():
    ...
    if args.preview:
        ...
        for row,unit in enumerate(['musketeer','laser-soldier','plasma-trooper']):
...
<main><h1>Schützenfamilie: 8 → 16 echte Blender-Frames</h1><p>Links aktueller Stand, rechts isolierte Studie. Drei Gangzyklen à 520 ms und drei Angriffe à 320 ms; Kontakt nach 160 ms. Beide Hände folgen festen Punkten der Waffe. Musketen-, Laser- und Plasma-Geometrie sind erhalten; Zielhaltung und Rückstoß unterscheiden sich. Produktionsstand unverändert.</p>'''+''.join(sections)+'''
