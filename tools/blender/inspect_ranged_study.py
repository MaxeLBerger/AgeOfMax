...
for unit in ['rifleman','sniper']:
    for faction in ['player','enemy']:
        ...
        print('weapon_parts',[(name,obj['location'],obj['groups']) for name,obj in objects.items() if any(word in name.lower() for word in ['rifle','stock','receiver','grip','magazine','hand','boot','sole'])])
